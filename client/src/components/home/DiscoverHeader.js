  ...
  return (
    <div className="discover-header kScroll">
      <h2 className="header-welcome is-size-1 is-size-3-touch">
        ...
        <span className="ws-nowrap is-size-4 is-size-5-touch">Sweet, getting started</span>{" "}
        <span className="ws-nowrap is-size-4 is-size-5-touch">is pretty dang easy.</span>
      </h2>
      ...
      <div className="header-step">
        ...
        <div className="step-description">
          <h2 className="is-size-3 is-size-4-touch">Find groups that <span className="ws-nowrap">interest you</span></h2>
          <p>
      ...
      <div className="header-step">
        ...
        <div className="step-description">
          <h2 className="is-size-3 is-size-4-touch">Join and participate <span className="ws-nowrap">on the fly</span></h2>
          <p>
