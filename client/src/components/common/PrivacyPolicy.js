    ...
    <Modal trigger={trigger}>
      <div className="hs-box info-modal is-vcentered">
        ...
        <div className="content">
          ...
          <br />
          <br />
          Thank you for choosing to be part of our community at HappenStack
          ...
          <br />
          <br />
          When you visit our website https://www.happenstack.com, and use our
          ...
          website (such as https://www.happenstack.com), and/or any related
          ...
          <br />
          <br />
          Personal Information Provided by You. We collect purchase history, and
          other similar data.
          <br />
          <br />
          ...
          <br />
          <br />
          Online Identifiers. We collect device's geolocation, and other similar
          data.
          <br />
          <br />
          <br />
          ...
          hold to determine how to respond. <br />
          <br />
          ...
          to serve ads when you visit the Services. These companies may use
          information about your visits to our Website(s) and other websites
          ...
          outside the Services in perpetuity. Similarly, other users will be
          ...
          contact us at happenstackhelp@gmail.com.
          <br />
          <br />
          <br />
          ...
          will be notified about data breaches when HappenStack believes you are
          likely to be at risk of serious harm. For example, a data breach may
          be likely to result in serious financial harm or harm to your mental
          or physical well-being. In the event that HappenStack becomes aware of
          a security breach which has resulted or may result in unauthorized
          access, use or disclosure of personal information HappenStack will
