  ...
  const questionList = [
    {
      ...
      answerText:   (<Fragment>'LFG', or 'Looking For Group', is a common term in online video games. Players run around shouting 'LFG' in order to find others that want to work together in order to accomplish a shared goal. In a nutshell, this is what HappenStack aims to bring into the real world. Our goal is to provide a platform for people to easily find and connect with others on an emergent basis.<br/><br/>Whatever you're up to, HappenStack is the real-time access-anywhere group-finding venue that makes it simpler, faster, and easier.</Fragment>)
    },
    {
      questionText: "How do groups work?",
      answerText: (<Fragment>Groups are HappenStack's bread and butter! Each group is organized within a 'Group Type' which loosely defines its purpose. In general, groups are meant to represent things happening either now or soon. Since humans like us can (mostly) do only one thing at a time, <strong>users can only be a part of one group at a time.</strong> There are 3 primary types of groups:<br/><br/><strong>Public groups</strong> show up on group type feeds.
      Anyone is free to join at any time.
      <br />
      <strong>Protected groups</strong> also show up on group type
      feeds. Users must request to join, and any of the group's
      admins can answer the request.
      <br />
      <strong>Private groups</strong> do not show up in feeds and
